...
public class UILabelWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("quadsPerCharacter", get_quadsPerCharacter, null);
	...
	static int get_quadsPerCharacter(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UILabel obj = (UILabel)o;
			int ret = obj.quadsPerCharacter;
			LuaDLL.lua_pushinteger(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index quadsPerCharacter on a nil value" : e.Message);
		}
	}
