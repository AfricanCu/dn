...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(SceneHelper)),
        _GT(typeof(ResHelper)),
        _GT(typeof(EventHelper)),
        _GT(typeof(InteractiveObj)),
        _GT(typeof(InObjHelper)),
        _GT(typeof(LayerHelper)),
        ...
        //FSM
        _GT(typeof(AnimationMgr)),
        _GT(typeof(FsmShell)),
        _GT(typeof(FsmMgr)),

        //场景摄像机
        _GT(typeof(SimpleCamCtrl)),

        //CountDown
        _GT(typeof(CountDown)),
        _GT(typeof(CountDownMgr)),

        //灯光贴图切换器
        //_GT(typeof(LightMapSwitcher)),
        _GT(typeof(PrefabLightmapData)),
        
        //昼夜切换
        _GT(typeof(DayNightMgr)),

        //魔窗
        _GT(typeof(MagicWin)),

        //平台
        _GT(typeof(PlatformTool)),
        
        //文件操作
        _GT(typeof(System.IO.File)),

        _GT(typeof(EasingCurvesUtil)),

        //add
        //_GT(typeof(Runs)),
        _GT(typeof(NumberSetting)),

        _GT(typeof(CardDrag)),
        _GT(typeof(HanderCom)),
        _GT(typeof(DeskDir)),
        _GT(typeof(SpineCtrl)),

        //物理位置
        _GT(typeof(LocationTool)),
        _GT(typeof(UpdateConfig)),
        _GT(typeof(TFVoiceTool)),
    };
