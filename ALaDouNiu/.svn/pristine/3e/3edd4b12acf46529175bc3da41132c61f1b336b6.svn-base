...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		NetHelperWrap.Register(L);
		SceneHelperWrap.Register(L);
		ResHelperWrap.Register(L);
		EventHelperWrap.Register(L);
		InteractiveObjWrap.Register(L);
		InObjHelperWrap.Register(L);
		...
		GameObjectUITitelWrap.Register(L);
		UITextureWrap.Register(L);
		UIPopupListWrap.Register(L);
		AnimationMgrWrap.Register(L);
		FsmShellWrap.Register(L);
		FsmMgrWrap.Register(L);
		SimpleCamCtrlWrap.Register(L);
		CountDownWrap.Register(L);
		CountDownMgrWrap.Register(L);
		PrefabLightmapDataWrap.Register(L);
		DayNightMgrWrap.Register(L);
		MagicWinWrap.Register(L);
		PlatformToolWrap.Register(L);
		EasingCurvesUtilWrap.Register(L);
		NumberSettingWrap.Register(L);
		CardDragWrap.Register(L);
		HanderComWrap.Register(L);
		DeskDirWrap.Register(L);
		SpineCtrlWrap.Register(L);
		LocationToolWrap.Register(L);
		TFVoiceToolWrap.Register(L);
		...
		UnityEngine_HandheldWrap.Register(L);
		...
		L.BeginModule("Update");
		Asset_Script_Update_UpdateConfigWrap.Register(L);
		L.EndModule();
		L.BeginModule("Core");
		Asset_Script_Core_Singleton_LuaHelperWrap.Register(L);
		Asset_Script_Core_Singleton_Asset_Script_Update_UpdateConfigWrap.Register(L);
		L.EndModule();
		L.EndModule();
		L.EndModule();
	...
	static int UIDrawCall_OnCreateDrawCall(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(UIDrawCall.OnCreateDrawCall), func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(UIDrawCall.OnCreateDrawCall), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
