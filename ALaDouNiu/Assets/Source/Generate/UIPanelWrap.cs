...
public class UIPanelWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("generateUV2", get_generateUV2, set_generateUV2);
		L.RegVar("shadowMode", get_shadowMode, set_shadowMode);
		...
		L.RegVar("onCreateMaterial", get_onCreateMaterial, set_onCreateMaterial);
		L.RegVar("onCreateDrawCall", get_onCreateDrawCall, set_onCreateDrawCall);
	...
	static int get_generateUV2(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIPanel obj = (UIPanel)o;
			bool ret = obj.generateUV2;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index generateUV2 on a nil value" : e.Message);
		}
	}
	...
	static int get_shadowMode(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index shadowMode on a nil value" : e.Message);
		}
	}
	...
	static int get_onCreateMaterial(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIPanel obj = (UIPanel)o;
			UIPanel.OnCreateMaterial ret = obj.onCreateMaterial;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index onCreateMaterial on a nil value" : e.Message);
		}
	}
	...
	static int get_onCreateDrawCall(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index onCreateDrawCall on a nil value" : e.Message);
		}
	}
	...
	static int set_onCreateMaterial(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIPanel obj = (UIPanel)o;
			UIPanel.OnCreateMaterial arg0 = null;
			LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

			if (funcType2 != LuaTypes.LUA_TFUNCTION)
			{
				 arg0 = (UIPanel.OnCreateMaterial)ToLua.CheckObject(L, 2, typeof(UIPanel.OnCreateMaterial));
			}
			else
			{
				LuaFunction func = ToLua.ToLuaFunction(L, 2);
				arg0 = DelegateFactory.CreateDelegate(typeof(UIPanel.OnCreateMaterial), func) as UIPanel.OnCreateMaterial;
			}

			obj.onCreateMaterial = arg0;
			return 0;
		}
		catch(Exception e)
		{
	...
	static int set_onCreateDrawCall(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIPanel obj = (UIPanel)o;
			UIDrawCall.OnCreateDrawCall arg0 = null;
			LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

			if (funcType2 != LuaTypes.LUA_TFUNCTION)
			{
				 arg0 = (UIDrawCall.OnCreateDrawCall)ToLua.CheckObject(L, 2, typeof(UIDrawCall.OnCreateDrawCall));
			}
			else
			{
				LuaFunction func = ToLua.ToLuaFunction(L, 2);
				arg0 = DelegateFactory.CreateDelegate(typeof(UIDrawCall.OnCreateDrawCall), func) as UIDrawCall.OnCreateDrawCall;
			}
	...
	static int UIPanel_OnCreateMaterial(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(UIPanel.OnCreateMaterial), func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(UIPanel.OnCreateMaterial), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
