...
public class UIPopupListWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("keepValue", get_keepValue, set_keepValue);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_keepValue(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIPopupList obj = (UIPopupList)o;
			bool ret = obj.keepValue;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index keepValue on a nil value" : e.Message);
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_keepValue(IntPtr L)
	{
		object o = null;
