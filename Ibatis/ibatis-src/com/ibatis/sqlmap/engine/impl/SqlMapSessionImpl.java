...
public class SqlMapSessionImpl implements SqlMapSession {
	...
	public Object insert(String id, Object param) throws SQLException {
		...
		Object insert = delegate.insert(sessionScope, id, param);
		if (log.isDebugEnabled())
			log.debug(String.format("%s耗时ms", id,
	...
	public int update(String id, Object param) throws SQLException {
		long time = System.currentTimeMillis();
		int update = delegate.update(sessionScope, id, param);
		if (log.isDebugEnabled())
			log.debug(String.format("%s耗时ms", id,
					(System.currentTimeMillis() - time)));
		return update;
	...
	public Object queryForObject(String id, Object paramObject)
			throws SQLException {
		long time = System.currentTimeMillis();
		Object queryForList = delegate.queryForObject(sessionScope, id,
				paramObject);
		if (log.isDebugEnabled())
			log.debug(String.format("%s耗时ms", id,
					(System.currentTimeMillis() - time)));
	...
	public Object queryForObject(String id) throws SQLException {
		Object queryForList = queryForObject(id, null);
		return queryForList;
	}
	...
	public List queryForList(String id, Object paramObject) throws SQLException {
		long time = System.currentTimeMillis();
		List queryForList = delegate
				.queryForList(sessionScope, id, paramObject);
		if (log.isDebugEnabled())
			log.debug(String.format("%s耗时ms", id,
					(System.currentTimeMillis() - time)));
		return queryForList;
	...
	public List queryForList(String id) throws SQLException {
		List queryForList = queryForList(id, null);
		return queryForList;
	}
	...
	public List queryForList(String id, Object paramObject, int skip, int max)
			throws SQLException {
		long time = System.currentTimeMillis();
		List queryForList = delegate.queryForList(sessionScope, id,
				paramObject, skip, max);
		if (log.isDebugEnabled())
			log.debug(String.format("%s耗时ms", id,
					(System.currentTimeMillis() - time)));
		return queryForList;
	...
	public List queryForList(String id, int skip, int max) throws SQLException {
		List queryForList = queryForList(id, null, skip, max);
		return queryForList;
	}
	...
	public PaginatedList queryForPaginatedList(String id, Object paramObject,
		...
		return delegate.queryForPaginatedList(sessionScope, id, paramObject,
				pageSize);
	}
	...
	public Map queryForMap(String id, Object paramObject, String keyProp)
			throws SQLException {
		long time = System.currentTimeMillis();
		Map queryForList = delegate.queryForMap(sessionScope, id, paramObject,
				keyProp);
		if (log.isDebugEnabled())
			log.debug(String.format("%s耗时ms", id,
					(System.currentTimeMillis() - time)));
