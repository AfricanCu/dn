...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`aladn3d` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `charge` (
  ...
  `agency` int(11) NOT NULL DEFAULT '0' COMMENT '代理邀请码',
  `diamond` int(11) DEFAULT '0' COMMENT '充值钻石数',
  `money` varchar(256) DEFAULT NULL COMMENT '金额',
  `apple_receipt` varchar(256) DEFAULT NULL,
  `status` int(11) DEFAULT '0' COMMENT '状态0待处理1处理',
...
CREATE TABLE `guild` (
  ...
  `serverId` int(11) DEFAULT '0' COMMENT '最近登录服务器id',
